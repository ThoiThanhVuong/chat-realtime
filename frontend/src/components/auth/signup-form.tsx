...
export function SignupForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input type="email" id="email" placeholder="email@gmail.com" {...register("email")} />
                {errors.email && (
      ...
      <div className="text-sx text-balance px-6 text-center text-muted-foreground *:[a]:hover:text-primary *:[a]:underline *:[a]:underline-offset-4">
